function ClimateChange() {
  ...
  this.icon = "assets/lineGraphWithGradient.jpg";
  ...
  this.title = 'World climate change from 1880 to 2018';
  ...
  this.setup = function() {
    ...
    this.slidersTitle = createDiv("Scale of the graph").addClass('selectTitle').parent('rightSideContainer');
    this.startSlider = createSlider(this.minYear,
                                    this.maxYear - 1,
                                    this.minYear,
                                    1);
    this.startSlider.parent('rightSideContainer');

    this.endSlider = createSlider(this.minYear + 1,
                                  this.maxYear,
                                  this.maxYear,
                                  1);
    this.endSlider.parent('rightSideContainer');
  };
  ...
  this.draw = function() {
    ...
    for (let i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null
        ...
        rect(this.mapYearToWidth(previous.year),this.layout.topMargin,segmentWidth,this.layout.bottomMargin-35);
          
        console.log(this.mapYearToWidth(current.year),this.layout.topMargin,segmentWidth,100);
