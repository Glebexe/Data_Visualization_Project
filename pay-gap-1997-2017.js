function PayGapTimeSeries() {
  ...
  this.name = 'Pay gap';
  this.icon = "assets/lineGraph.jpg";
  ...
  this.title = 'Average difference between male and female pay from 1997 to 2017';
  ...
  this.draw = function() {
    ...
    for (let i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null) {
        ...
        // year pay gap.
        stroke(0);
        line(this.mapYearToWidth(previous.year),this.mapPayGapToHeight(previous.payGap),
